...
"""
    1. Obtaining the Vocabulary
    extract a set of words and POS tags that appear in the training data
    necessary to format the input to the neural net
    (the dimensionality of the input vectors depends on the number of words)
